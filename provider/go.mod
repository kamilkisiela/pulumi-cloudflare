...
replace github.com/cloudflare/terraform-provider-cloudflare => github.com/kamilkisiela/terraform-provider-cloudflare v0.0.0-20221124124418-0e8b1ea5b5dc
...
require (
	...
	github.com/cloudflare/cloudflare-go v0.55.1-0.20221124092905-79999fcb7e72 // indirect
